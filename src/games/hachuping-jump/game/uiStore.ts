...
export function emptySnapshot(): UISnapshot {
  return { status: "playing", score: 0, bestScore: 0, finalScore: null, stars: 0, shieldTime: 0, magnetTime: 0, doubleTime: 0, slowTime: 0, hearts: 0, stage: 0, stageCleared: 0, journeyPhase: 'intro', phaseTime: 2, lastStageScore: 0 };
}
