...
export default function Leaderboard({ entries }: LeaderboardProps) {
  return (
    <div className="pointer-events-none absolute right-3 top-3 w-36 rounded-xl bg-black/40 px-3 py-2 text-white backdrop-blur-sm sm:right-4 sm:top-4 sm:w-44">
