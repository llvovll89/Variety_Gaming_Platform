    ...
    <div className="relative h-full w-full">
      ...
      {screen === "menu" && (
        <>
          <button
            onClick={onExit}
            className="absolute left-3 top-3 z-10 rounded-full bg-black/40 px-3 py-1.5 text-xs font-semibold text-white/80 backdrop-blur-sm transition hover:bg-black/60 hover:text-white sm:left-4 sm:top-4"
          >
            ← 허브로
          </button>
